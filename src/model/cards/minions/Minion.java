...
public class Minion extends Card implements Cloneable {
	...
	public String toString(){
		String s="";
		s+="<html><font size=-1>Name: "+this.getName()+"<br />";
		s+="Mana Cost: "+this.getManaCost()+"<br />";
		s+="Rarity: "+this.getRarity()+"<br />";
		s+="Attack: "+this.getAttack()+"<br />";
		s+="Current HP: "+this.getCurrentHP()+"<br />";
		if(this.isTaunt())
			s+="Taunt <br />";
		if(this.isDivine())
			s+="Divine <br />";
