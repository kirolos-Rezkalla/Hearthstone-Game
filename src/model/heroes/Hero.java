...
public abstract class Hero implements MinionListener {
	...
	public String toString(){
		String s="";
		s+="<html><br><font size=+1>Name: " + this.getName() + "<br />"
	    + "Current HP: " + this.getCurrentHP() +"<br /> "
		+ "Current Mana Crystals: " + this.getCurrentManaCrystals() + "<br />"
	    + "Total Mana Crystals: " +
		this.getTotalManaCrystals() + "<br/"
	    + "Cards left in Hand: " + this.getHand().size() + "<br />"
	    + "Cards left in Deck: " + this.getDeck().size() + "</html>";
		return s;
	}
